...
##FINAL VERSION: Bootstrap Coverage Sim Hetero
```{r}
sim_data%>%
  select(-X)%>%
  ...
  labs(x="Method",y="Coverage",title="Bootstrap Method Coverage - Simulated Heteroskedastic Data")+
...
sim_data%>%
  ...
  scale_x_discrete(labels=c("Classic","Cases BCA", "Residual BCA", "Wild BCA"))+
  scale_fill_manual(name="Parameter",breaks=c("itct","slope","sigma"),labels=c("Intercept","Slope","Sigma"),values=c("#66c2a5","#fc8d62","#8da0cb"))+
  labs(x="Method",y="Coverage",title="Bootstrap Method Coverage - Simulated Normal Data")+
  geom_text(check_overlap=TRUE,size=4,position=position_dodge(width=0.9),hjust=1.1,color="black")+
  theme_minimal()
```
...
sim_data%>%
  ...
  scale_x_discrete(labels=c("Classic","Cases BCA", "Residual BCA", "Wild BCA"))+
  scale_fill_manual(name="Parameter",breaks=c("itct","slope","sigma"),labels=c("Intercept","Slope","Sigma"),values=c("#66c2a5","#fc8d62","#8da0cb"))+
  labs(x="Method",y="Coverage",title="Bootstrap Method Coverage - Simulated Normal w/ Outliers")+
  geom_text(check_overlap=TRUE,size=4,position=position_dodge(width=0.9),hjust=1.1,color="black")+
  theme_minimal()
```
